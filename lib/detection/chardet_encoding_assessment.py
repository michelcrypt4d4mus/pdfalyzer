...
class ChardetEncodingAssessment:
    ...
    @classmethod
    def dummy_encoding_assessment(cls, encoding) -> 'ChardetEncodingAssessment':
        """Generate an empty ChardetEncodingAssessment to use as a dummy when chardet gives us nothing"""
