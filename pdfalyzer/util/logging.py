...
from pdfalyzer.output.theme import LOG_THEME_DICT, LABEL_STYLES, PDF_OBJ_TYPE_STYLES

PYPDF_LOG_PFX = PYPDF_LOG_PFX_PATTERN.replace("\\", '')


LogHighlighter.add_highlight_patterns(
    [regex_to_highlight_pattern(style_regex) for style_regex in LABEL_STYLES.keys()] +
